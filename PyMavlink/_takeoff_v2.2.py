...
# Global variable to monitor for return to launch command
return_to_launch_flag = False
...
def calculate_distance(pos1, pos2):
    # Simple distance calculation between two lat/lon points (Haversine formula)
    lat1, lon1 = pos1
    lat2, lon2 = pos2
...
def hold_position(hold_time):
    ...
    while time.time() - start_time < hold_time:
        ...
        if current_position and initial_position:
            deviation = calculate_distance(initial_position, current_position)
