...
def save_result(result: vision.ObjectDetectorResult, unused_output_image: mp.Image, timestamp_ms: int):
    ...
    for detection in result.detections:
        ...
        # Return the bounding box and distance for displaying on the screen
        return bbox, distance_to_object
    ...
    try:
        ...
        while True:
            ...
            if detection_frame is not None:
                ...
                if bbox is not None and distance is not None:
                    ...
                    midpoint_x = (center_x + int(bbox_center_x)) // 2
                    midpoint_y = (center_y + int(bbox_center_y)) // 2
                    cv2.putText(detection_frame, distance_text, (midpoint_x, midpoint_y), cv2.FONT_HERSHEY_SIMPLEX, 
                                1, (0, 165, 255), 2, cv2.LINE_AA)  # Orange
