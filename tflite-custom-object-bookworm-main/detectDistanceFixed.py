...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        def ask_to_log():
        response=input(
            "Do you want to log the data? (yes/no): ").strip().lower()
        return response == 'yes'
        ...
        # Calculate horizontal theta relative to the camera's FOV
        horizontal_theta=(horizontal_distance / screen_center_x) * \
    ...
    """
        ...
        while True:
            ...
            if detection_result_list:
                ...
                for detection in detection_result.detections:
                    ...
                    # Calculate horizontal theta relative to the camera's FOV
                    horizontal_theta=(adjusted_bbox_center_x / \
                                      center_x) * (horizontal_fov_degrees / 2)
        ...
        if __name__ == '__main__':
        main()
        ight of the frames to process', default=1080, type=int)
    args = parser.parse_args()
